        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttrList) in detailInfo.spuSaleAttrList" :key="spuSaleAttrList.id">
                ...
                <dd
                  ...
                  @click="allreadyChecked(index,spuSaleAttrList.spuSaleAttrValueList)"
...
export default {
  ...
  methods: {
    ...
    allreadyChecked(index, arr) {
      if (arr[index].isChecked === "1") return;
      arr.forEach(item => {
        item.isChecked = "0";
      });
